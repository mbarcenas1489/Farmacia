<x-app-layout>
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600">Consulta los usuarios registrados y administra sus roles.</p>
        </div>
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    @forelse($users as $user)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="whitespace-nowrap px-6 py-4">
                                <span class="inline-flex rounded-full bg-indigo-100 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-indigo-700">
